...
//purpose: search result page where customer can look up for houses as searched on the search box
...
?>
	...
	<div id="right_content">
		...
		$get_houses = "select * from houses where house_key like '%$search_key%'";
